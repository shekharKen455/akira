            ...
            <div class="section-container large p-l-r">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 header-left">
                        <div class="site-logo">
                            <a href="{{ route('home') }}">
                                <img width="400" height="140" src="{{ asset('media/akira-logo.png') }}"
                                    alt="Akira – Jewellery" />
                            </a>
                        </div>
                    </div>
                            ...
                            <nav id="main-navigation">
                                <ul id="menu-main-menu" class="menu">
                                    ...
                                    <li class="level-0 menu-item menu-item-has-children">
                                        <a href="{{ route('catelog') }}"><span
                                                class="menu-item-text">CATEGORIES</span></a>
                                        <ul class="sub-menu">
                                            @foreach ($categories as $cat)
                                                <li>
                                                    <a href="{{ route('category', $cat->id) }}"><span
                                    ...
                                    <li class="level-0 menu-item">
                                        <a href="{{ route('custom') }}"><span class="menu-item-text">CUSTOM
                                                ITEMS</span></a>
                                    </li>
                                    <li class="level-0 menu-item">
                                        <a href="{{ route('catelog') }}"><span
                                                class="menu-item-text">CATALOGS</span></a>
                                    </li>
                                    <li class="level-0 menu-item">
                        ...
                        <div class="header-page-link">
                                                ...
                                                @foreach ($cart as $item)
                                                    ...
                                                    <li class="mini-cart-item">
                                                        <a href="{{ route('cart.delete', $item['id']) }}"
                                                            class="removed-new" title="Remove this item"><i
                                                                class="icon_close"></i></a>
                                                        <a href="{{ route('product', $item['product']->slug) }}"
                                                            class="product-image"><img width="600" height="600"
                            ...
                            @if (auth() && auth()->user() && auth()->user()->email != 'admin@user.com')
                                <div class="login-header icon">
                                    <a class="active-login2" href="{{ route('account') }}"><i class="icon-user"></i>
                                        {{ auth()->user()->name }}
                                    </a>
                                </div>

                                <!-- <div class="mojuri-topcart dropdown light">
                                    <div class="dropdown mini-cart top-cart login-header icon">
                                        <div class="remove-cart-shadow"></div>
                                        <a class="dropdown-toggle cart-icon" href="#" role="button"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <div class="icons-cart active-login">
                                                <i class="icon-user"></i>
                                                {{ auth()->user()->name }}
                                            </div>
                                        </a>
                                        <div class="dropdown-menu cart-popup">
                                            <div class="cart-list-wrap">
                                                ...
                                                <div class="buttons">
                                                    <a href="{{ route('logout') }}"
                                                        class="button btn view-cart btn-primary">Logout</a>
                                                    <a href="{{ route('account') }}"
                                                        class="button btn checkout btn-default">Account</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @else
                                <div class="login-header icon">
                                    <a class="active-login2" href="{{ route('login') }}">
                                        <i class="icon-user"></i>
                                    </a>
                                </div>
                            @endif
