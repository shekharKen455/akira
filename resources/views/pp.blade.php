                ...
                <div id="title" class="page-title">
                    <div class="section-container">
                        ...
                        <div class="breadcrumbs">
                            <a href="{{ route('home') }}">Home</a><span class="delimiter"></span>Privacy Policy
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="intro-wrap">
                                            ...
                                            <div class="intro-text">
                                                At Akira Jewellery, we respect your privacy and are committed to safeguarding your personal information. This Privacy Policy outlines how we collect, use, share, and protect your data when you use our website or services.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="row">
                                            <div class="col-d-12 text-center">
                                                ...
                                                <div class="intro-text">
                                                    We collect personal information, including but not limited to names, addresses, emails, and payment details, when voluntarily provided by customers during the purchasing process. Additionally, we may collect non-personal information, such as browser information and IP addresses, for analytical purposes.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="row">
                                            ...
                                            <div class="section-column right">
                                                <div class="intro-wrap">
                                                    <h2 class="intro-title">Customer Photo Pendants Reference on TikTok</h2>
                                                    <div class="intro-item m-b-0">
                                                        Please note that by placing an order for a customized photo pendant, you consent to the potential use of the pendant's image for promotional purposes on our TikTok account. We prioritize respecting your privacy and will not disclose any personal information associated with the image, such as names or addresses, unless legally required.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="block block-intro layout-5 text-center">
                                    <div class="block-widget-wrap">
                                        <div class="intro-wrap">
                                            ...
                                            <div class="intro-text">
                                                The information collected is used to process orders, deliver products, improve customer service, and communicate regarding orders and promotions. We may also use non-personal information for analytical purposes to enhance our services.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="row">
                                            <div class="col-d-12 text-center">
                                                ...
                                                <div class="intro-text">
                                                    Akira Jewellery does not sell, trade, or rent your personal information to third parties. We may share information with trusted service providers who assist in operating our website or servicing customers, ensuring they uphold the same level of confidentiality.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="row">
                                            <div class="section-column left animation-horizontal hover-opacity">
                                                {{-- <img width="600" height="440" src="media/banner/intro-about-3.jpg" alt="intro"> --}}
                                                <div class="intro-wrap">
                                                    <h2 class="intro-title">Security Measures</h2>
                                                    <div class="intro-item m-b-0">
                                            ...
                                            <div class="section-column right">
                                                <div class="intro-wrap">
                                                    <h2 class="intro-title">Access and Control</h2>
                                                    <div class="intro-item m-b-0">
                                                        You have the right to access, correct, or delete your personal information held by Akira Jewellery. Please contact us if you wish to exercise these rights.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="block block-intro layout-5 text-center">
                                    <div class="block-widget-wrap">
                                        <div class="intro-wrap">
                                            ...
                                            <div class="intro-text">
                                                We reserve the right to update our Privacy Policy. Any changes will be posted on this page. By continuing to use our website after modifications, you agree to the updated policy.
                                            </div>
                                        </div>
                                    </div>
                                </div>
