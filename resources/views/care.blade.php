                ...
                <div id="title" class="page-title">
                    <div class="section-container">
                        ...
                        <div class="breadcrumbs">
                            <a href="{{ route('home') }}">Home</a><span class="delimiter"></span>Product Care
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="row">
                                            <div class="section-column left animation-horizontal hover-opacity">
                                                ...
                                                <div class="intro-wrap">
                                                    <h2 class="intro-title">Keep Away from moisture and harsh chemicals.</h2>
                                            ...
                                            <div class="section-column right">
                                                <div class="intro-wrap">
                                                    <h2 class="intro-title">Store your Piece in an airtigth box.</h2>
                                                    {{-- <div class="intro-item m-b-0">
                                                        Store your Piece in an airtigth box.
                                                    </div> --}}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="row">
                                            <div class="section-column left animation-horizontal hover-opacity">
                                                {{-- <img width="600" height="440" src="media/banner/intro-about-3.jpg" alt="intro"> --}}
                                                <div class="intro-wrap">
                                                    <h2 class="intro-title"> Avoid contact with lotion or perfume.</h2>
                                                    {{-- <div class="intro-item m-b-0">
                                            ...
                                            <div class="section-column right">
                                                <div class="intro-wrap">
                                                    <h2 class="intro-title">Remove when you go to sleep.</h2>
                                                    {{-- <div class="intro-item m-b-0">
                                                        Remove when you go to sleep.
                                                    </div> --}}
                                                </div>
                                            </div>
                                        </div>
