                ...
                <div id="title" class="page-title">
                    <div class="section-container">
                        ...
                        <div class="breadcrumbs">
                            <a href="{{ route('home') }}">Home</a><span class="delimiter"></span>Shipping Policy & Return
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="intro-wrap">
                                            ...
                                            <div class="intro-text text-left">
                                                <ul>
                                                    <li>
                                                        <strong>Worldwide Shipping:</strong> We proudly offer worldwide shipping at reasonable rates.
                                                    </li>
                                                    <li>
                                                        <strong>Shipping Time (Canada/USA):</strong> Delivery times within Canada and the USA typically range from 2 to 9 business days, depending on the specific location. Please note that these times may vary due to factors such as location and shipping carrier efficiency.
                                                    </li>
                                                    <li>
                                                        <strong>Shipping Time (Rest of the World):</strong> For international orders outside Canada and the USA, please expect delivery within 6 to 14 business days. This estimated time frame excludes holidays and may vary based on destination and customs processing.
                                                    </li>
                                                </ul>
                                            </div>
                                            <br><br>
                                            <div class="intro-text">
                                                <h2>Please note that shipping times are approximate and may be subject to unexpected delays beyond our control.</h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="block-widget-wrap">
                                        <div class="intro-wrap">
                                            ...
                                            <div class="intro-text text-left">
                                                <ul>
                                                    <li>
                                                        <strong>Customized Items</strong> Customized pieces are crafted especially for you and are non-returnable/non-exchangeable unless:
                                                    </li>
                                                    <li>
                                                        The item is wrongly delivered.
                                                    </li>
                                                    <li>
                                                        TThe item arrives in a damaged or broken condition.
                                                    </li>
                                                    <li>
                                                        Quality does not meet your satisfaction.
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <br><br>
                                            <div class="intro-text">
                                                <h2>We strive for your utmost satisfaction and will work diligently to address any issues regarding the delivery, condition, or quality of your order.</h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
